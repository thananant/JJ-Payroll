...
- **OT รายวัน**: ปุ่ม ＋OT ในตารางเข้างานหน้าข้อมูลพนักงาน (editOT) — **ใส่เป็นชั่วโมง** อัตราคิดอัตโนมัติรายคน = **ค่าแรงวัน ÷ 8** (otRateOf: รายเดือน ÷30÷8 เช่น 12,000 → 50 บ./ชม. · รายชั่วโมงใช้เรตตัวเอง) · เก็บเป็น adjustments kind add, reason `OT <วัน> (X ชม.)` · ใส่ 0/เว้นว่าง = ลบ · หมายเหตุ: คอลัมน์ `payroll_settings.ot_rate` เลิกใช้แล้ว (เปลี่ยนเป็นสูตรอัตโนมัติ)
